...
model = XGBRegressor(n_estimators=100, learning_rate=0.1, max_depth=3, random_state=69)
...
#print("Train_r2_s											core: ", r2_score(y_train, train_pred))
#print("\n")
...
score = cross_val_score(model, x, y, cv=LeaveOneOut(), scoring='neg_mean_squared_error')
print(score)
